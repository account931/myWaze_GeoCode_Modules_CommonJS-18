<?php
 //This  the  version with all  fields  filled    
?>
...
$dateStart=$date."+09:00";      // i.e //2016-07-29+09:00
$dateEnd=$date."+13:30"; 
...
<div>
 <h1>Calculating  current  date and  completing  your  form for </br><span  style="color:red;font-size:26px;"> <?php echo /*"user"*/$user;?> </span></h1>
...
//redirecting  to URL IN 2  seconds
 setTimeout(function(){
       window.location = "https://docs.google.com/forms/d/e/1FAIpQLScqyMgAlTh7vz4kv4EqhQ8Xx0Nv-LLuAAZllf9ulQAqvPPQcA/viewform?entry.732072469=Kate&entry.1845541901=<?php echo $user;?>&entry.1076665963=Venues&entry.1765260159_hour=04&entry.1765260159_minute=30&entry.2075579474=<?php  echo $dateStart;?>&entry.163039792=<?php  echo $dateEnd;?>     ";
       <?php
