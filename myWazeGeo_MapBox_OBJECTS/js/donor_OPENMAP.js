...
var d=arrayX2.length; alert('array contains -> '+d);
...
var hFinal='</br><p style="color:red;">RESULTS</br> </br><input type="button" value="Copy" id="copybutton"><span id="flashMessage"></span> </br></br><table id="tableResults">';
...
var data = $.parseJSON($.ajax({
        url:  'https://api.mapbox.com/geocoding/v5/mapbox.places/'+arrayX2[j]+'.json?country=us&access_token=pk.eyJ1IjoiYWNjb3VudDkzMSIsImEiOiJjaXgwOTVuOTEwMGFxMnVsczRwOWx0czhnIn0.YjZ5bpnh6jqTEk7cCJfrzw',
        dataType: "json", 
        async: false
    }).responseText); 
	
//End  new  Async*******************************
dataX=dataX+'<tr><td>'+     data.features[0].center[1]+   '</td><td>' +data.features[0].center[0]+   '</td></tr>';  //alert("screw -> "+dataX);
