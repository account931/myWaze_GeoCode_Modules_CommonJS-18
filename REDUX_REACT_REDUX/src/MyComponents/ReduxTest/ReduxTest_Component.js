...
const mapStateToProps = state => ({
    geod: state.geodReducer, // {geod} is the name of props we will use in this component(i.e this.props.geod.title), //{geodReducer} is a name of reucer set in reducers/redux_reducers.js
});
