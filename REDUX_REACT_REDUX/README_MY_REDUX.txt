...
4. How TO SUBSCRIBE A COMPONENT TO REDUX STORE (how to listen to and re-render changes):
4.1 Add import in component itself:
    import { connect } from 'react-redux';
    import { store } from '../../Redux_actions_reducers_store/store/redux_store';  //import redux store.
	
4.2 Remove default class export {//export default Results;} + add export to class directly {export class Results extends Component{} }

4.3 Add in the end of component, after the class:
//REDUX part
// AppContainer.js
...
const mapDispatchToProps = {
  //pass_coords_to_Redux,  //action are not used here
};
...
5. HOW TO SEND NEW VALUES TO REDUX STORE(how to change Redux store values):

5.1 Add import in component itself:
   import { connect } from 'react-redux';
   import { pass_coords_to_Redux/*, closeGeod*/ } from '../../Redux_actions_reducers_store/actions/redux_actions';		//import actions used			

5.2 Remove default class export {//export default Results;} + add export to class directly {export class Results extends Component{} }

5.3 In component itself call your function:
		this.props.pass_coords_to_Redux({ rrr: this.state.coordinateArray });   //assign to REDUX rrr array with final coords
		
5.4. Create file with Redux actions (redux_actions.js):
...
5.5 Create file with Redux reducers (redux_reducers.js):
     case 'PASS_COORDS_TO_REDUX':
     return action.myCoordsX;  //action name must be the same as in redux_actions.js -> myCoordsX
	 
5.6  Create file with Redux store (redux_store.js):
5.6.1  import { geodReducer, reducers } from '../reducers/redux_reducers'; //import reducers //{geodReducer} is a reducer name as specified in /reducers/redux_reducers.js
5.6.2  // store.js  //{geodReducer} is a reducer name as specified in /reducers/redux_reducers.js
...
=================
6. Alternatively, to keep it more simple, u can combine redux_actions.js, redux_reducers.js, redux_store.js files in one file
(example is Redux_actions_reducers_store/redux.js, it is now 100% commented, as we splitted redux.js to 3 diffrenet files)
