...
<!--------------------------------------------------- TextArea FORm  Start------------------------------------------------->
    					...
    					<form role="form">  	
    				  		...
    				  		<div class="form-group">
    				  			<textarea class="form-control" rows="4" placeholder="Column1" id='coordsInput' required></textarea>
...
<!-------------------------------------------------------START BUTTONS---------------------------------------->
					...
					<div class="col-md-8"  id="" style="margin-top:33px;">  
    				  		...
    				  		<button id="splitButton" type="button" class="btn btn-primary btn-embossed btn-lg btn-wide">Submit request</button>
